...
async function getSongs(folder) {
  ...
  songUL.innerHTML = "" //Cleaning List When New Album is Clicked
  for (const song of songs) { //Populating Song-List from Songs array 
  ...
  Array.from(document.querySelector(".songList").getElementsByTagName("li")).forEach(e => {   
    e.querySelector(".playnow").getElementsByTagName('img')[0].addEventListener("click", element => {
